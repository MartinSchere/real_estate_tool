...
class TestClient(TestCase):
    ...
    def test_create_property(self):
        ...
        self.mock_property['tenant'] = Tenant.objects.get_or_create(rental_property=prop, **self.mock_tenant)
        res = self.client.post(
            '/properties/create/', self.mock_property)
        self.assertIsNotNone(Property.objects.last(), "Property was not created")
