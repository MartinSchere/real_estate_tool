# Generated by Django 3.1 on 2020-09-26 00:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RenameField(
            ...
            new_name='down_payment_currency',
        ),
        migrations.AddField(
            model_name='loan',
            name='program',
            field=models.CharField(choices=[('30F', '30-year-fixed'), ('15F', '15-year-fixed'), ('51A', '5/1 ARM')], default=1, max_length=30),
            preserve_default=False,
        ),
        migrations.AddField(
            model_name='loan',
            name='total_price',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default_currency='USD', max_digits=20),
        ),
        migrations.AddField(
            model_name='loan',
